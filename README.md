...
[![Profile Views](https://komarev.com/ghpvc/?username=ToBee94&label=Profile%20Views&color=26d0ce&style=flat-square)](https://github.com/ToBee94)
[![Followers](https://img.shields.io/github/followers/ToBee94?label=Followers&style=flat-square&color=1a2980)](https://github.com/ToBee94?tab=followers)
[![Website](https://img.shields.io/badge/fuewa.systems-26d0ce?style=flat-square&logo=firefox&logoColor=white)](https://fuewa.systems)
...
final class Tobias
{
    ...
    public string $company  = 'fuewa.systems // Eventim Tech GmbH';
    public string $location = 'Bremen, Germany 🇩🇪';

    public array $focus = [
        'Clean, well-documented API clients & SDKs',
        'Multi-tenant infrastructure & SSH key management',
        'Symfony + Docker stacks that scale',
        'Open structured data for the grow community',
    ];

    public function currently(): string
    {
        return 'Shipping Shellock — role-based SSH access, done right.';
    }
}
```
...
[![Website](https://img.shields.io/badge/fuewa.systems-26d0ce?style=for-the-badge&logo=googlechrome&logoColor=white)](https://fuewa.systems)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/ToBee94)

<br/><br/>

<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:26d0ce,100:1a2980&height=120&section=footer&text=Thanks%20for%20stopping%20by!&fontSize=20&fontColor=ffffff&fontAlignY=70&animation=fadeIn"/>
